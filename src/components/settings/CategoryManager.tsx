                        ...
                        <div className="flex items-center p-3 gap-2 group">
                            ...
                            {editingId === cat.id ? (
                                <form onSubmit={(e) => handleUpdate(e, 'category')} className="flex-1 flex gap-2">
                                    ...
                                    />
                                    <button type="submit" className="text-xs text-green-500 hover:text-green-400">Save</button>
                            ...
                            <div className="pl-9 pr-3 pb-3">
                                ...
                                <div className="space-y-1 mb-2">
                                    {subCategories[cat.id]?.map(sub => (
                                        <div key={sub.id} className="text-sm text-gray-400 flex items-center gap-2 py-1 group/sub">
